...
Usage: /ra-references <file_path> <line> <character>

Example: /ra-references src/main.rs 5 10
...
RESULT=$(curl -s -X POST "http://localhost:${RUST_ANALYZER_PORT:-15423}/api/v1/rust_analyzer_references" \
